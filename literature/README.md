...
| Priority | Stored file                    | Author(s) | Year | Title                                             | Topic               | Thesis relevance                                                                                          | Suggested citation location            |
| -------- | ------------------------------ | --------- | ---: | ------------------------------------------------- | ------------------- | --------------------------------------------------------------------------------------------------------- | -------------------------------------- |
| **9**    | `IPCC_AR6_WGI_Full_Report.pdf` | IPCC      | 2021 | _Climate Change 2021: The Physical Science Basis_ | AR6 WG1 full report | **High** — authoritative climate-science context for bias-correction motivation; bib key `ipcc2021ar6wg1` | ClimateApplication §1, Introduction §1 |

## Peripheral Literature

| Priority | Stored file                                                | Author(s)                  | Year | Title                                                                                                            | Topic                        | Thesis relevance                                                                                           | Suggested citation location |
| -------- | ---------------------------------------------------------- | -------------------------- | ---: | ---------------------------------------------------------------------------------------------------------------- | ---------------------------- | ---------------------------------------------------------------------------------------------------------- | --------------------------- |
| **10**   | `Effects_of_univariate_and_multivariate_bias_correc-1.pdf` | Judith Meyer et al.        | 2018 | _Effects of univariate and multivariate bias correction on hydrological impact projections in alpine catchments_ | Hydrological bias correction | **Medium** — application-side evaluation of univariate vs multivariate correction; not yet in bibliography | ClimateApplication §3       |
| **11**   | `mixed-precision/120444523.pdf`                            | Josef Martnek              | 2023 | _Mixed Precision in Uncertainty Quantification Methods_                                                          | Mixed-precision UQ           | **Low** — outside the main RandNLA focus                                                                   | —                           |
| **12**   | `mixed-precision/2406.02701v3.pdf`                         | Mary Lai O. Salvana et al. | 2024 | _MPCR: Multi-Precision Computations Package in R_                                                                | R mixed-precision tooling    | **Low** — peripheral tooling reference                                                                     | package documentation       |
| **13**   | `130370638.pdf`                                            | Ján Kovačovský             | 2023 | _Non-additive intermolecular interactions_                                                                       | Bachelor thesis              | **None** — unrelated earlier thesis                                                                        | —                           |
