...
\begin{theorem}[Perturbation of covariance transport]
	...
	regularized spectral gaps, this behaves like a constant depending on
	\(\lambda_{\min}(C_X+\lambda I)\) and \(\lambda_{\min}(C_Y+\lambda I)\).
	In particular, the inverse-square-root term deteriorates at the rate
	\(\lambda_{\min}(C_X+\lambda I)^{-3/2}\).
\end{theorem}
...
\begin{algorithm}[t]
	...
	Form randomized covariance sketches in precision \(u_\ell\):
	\[
		Y_X = \tfrac{1}{n}Z_X^\top(Z_X\Omega_X),\qquad
