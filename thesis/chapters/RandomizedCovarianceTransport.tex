...
\]
for the future sample. We then define
\[
...
\begin{proof}[Proof sketch]
	These bounds express the scalar derivative behavior of
	\(t \mapsto t^{-1/2}\) and \(t \mapsto t^{1/2}\) through spectral calculus. The
