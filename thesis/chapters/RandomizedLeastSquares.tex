...
For the present thesis, this paradigm is important for two reasons. First, it clarifies that randomized least squares is not exhausted by direct sketch-and-solve methods; preconditioning is equally central to the modern literature. Second, it provides a natural bridge to mixed precision. Once the sketch is interpreted as a preconditioner-construction stage, one can ask a more refined numerical question: which parts of that construction may be carried out in lower precision without destroying the conditioning gains that justify the randomized step in the first place? This is exactly the kind of coupled approximation-and-arithmetic question that later experiments should address.
